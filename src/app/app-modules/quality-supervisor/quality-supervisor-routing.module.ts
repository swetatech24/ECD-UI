...
const routes: Routes = [
  { path: '', redirectTo: 'innerpage-quality-supervisor', pathMatch: 'full' },
  { path: 'innerpage-quality-supervisor', component: InnerpageSupervisorComponent },
  { path: 'qualityAudit-sectionConfif', component: QualitySectionConfigurationComponent}
];
...
export class QualitySupervisorRoutingModule { }
